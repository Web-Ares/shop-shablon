...
(function($, document) {
    ...
    var jck_wt = {
        ...
        thumbnails_slider_args: function() {
            ...
            return {
                mode: ( jck_wt_vars.options.thumbnailLayout === "above" || jck_wt_vars.options.thumbnailLayout === "below" ) ? "horizontal" : "vertical",
                infiniteLoop: false,
        ...
        setup_sliders: function() {
            ...
            if( jck_wt.els.thumbnails.length > 0 && jck_wt_vars.options.navigationType === "sliding" ) {
        ...
        watch_variations: function() {
            ...
            jck_wt.els.variation_id_field.on('change', function() {
                ...
                if( isNaN(variation_id) ) {
                    ...
                    // wait 250ms then check if it's still empty, as it's
                    // triggered when the field is cleared before the new variation
                    // id is entered by woocommerce

                    setTimeout(function(){

                        if( jck_wt.els.variation_id_field.val() === "" && currently_showing !== jck_wt.vars.product_id ) {
        ...
        load_images: function( variation ) {
            ...
            if( variation ) {
                ...
                if( variation.additional_images ) {

                    var image_count = variation.additional_images.length;

                    if( image_count > 0 ) {

                        jck_wt.els.all_images_wrap.removeClass( jck_wt.vars.reset_class );

                        jck_wt.replace_images( variation.additional_images, function(){
        ...
        replace_images: function( images, callback ) {
            ...
            temp_images.container.imagesLoaded( function() {
                ...
                if( jck_wt.vars.images_slider_data ) { jck_wt.vars.images_slider_data.reloadSlider( jck_wt.images_slider_args() ); }
                if( jck_wt.vars.thumbnails_slider_data ) { jck_wt.vars.thumbnails_slider_data.reloadSlider( jck_wt.thumbnails_slider_args() ); }
        ...
        create_temporary_images: function( images ) {
            ...
            if( image_count !== 1 && image_count < jck_wt_vars.options.thumbnailCount ) {
        ...
        setup_fullscreen: function() {
            ...
            $(document).on('click', jck_wt.vars.fullscreen_trigger, function(){
                ...
                var options = {
                    ...
                    // for example:
                    index: items.index, // start at first slide
                    shareEl: false
                };
        ...
        get_gallery_items: function() {
            ...
            if( jck_wt.is_true( jck_wt_vars.options.enableInfiniteLoop ) ) {
                index = index-1;
            }
